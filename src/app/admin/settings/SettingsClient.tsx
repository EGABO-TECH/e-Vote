              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
                  ...
                  <div 
                    ...
                    style={{ width: 44, height: 24, background: settings.enforce_2fa ? 'var(--blue)' : 'var(--surface-3)', borderRadius: 99, position: 'relative', cursor: 'pointer', transition: 'background 0.2s' }}
                  >
                    <div style={{ width: 20, height: 20, background: '#fff', borderRadius: '50%', position: 'absolute', top: 2, right: settings.enforce_2fa ? 2 : 'auto', left: settings.enforce_2fa ? 'auto' : 2, transition: 'all 0.2s' }}></div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <input 
                      style={{ width: 96, padding: '12px 16px', background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 8, fontWeight: 700, textAlign: 'center', color: 'var(--text-1)', fontSize: 14, outline: 'none' }} 
                      type="number" 
