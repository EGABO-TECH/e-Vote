      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.875rem', marginBottom: '1.5rem' }}>
            Candidate registration is open &middot; Voting opens in 14 days
          </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: '1rem' }}>
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '1.3rem', fontWeight: 900, color: 'var(--text-1)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>{metrics.voters.toLocaleString()}</p>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '1.3rem', fontWeight: 900, color: 'var(--text-1)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>{metrics.candidatesApproved} / {metrics.candidatesPending}</p>
            <p style={{ fontSize: '0.72rem', color: 'var(--amber)' }}>{metrics.candidatesPending} pending review</p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span className="material-symbols-outlined" style={{ fontSize: '20px', color: '#fff', fontVariationSettings: '"FILL" 1' }}>sync</span>
          </div>
          <div>
            <p style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>SYNC HEALTH</p>
            <p style={{ fontSize: '1.3rem', fontWeight: 900, color: 'var(--text-1)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>{metrics.syncReconciled} / {metrics.syncTotal}</p>
            <p style={{ fontSize: '0.72rem', color: 'var(--green)' }}>All synced</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        <div style={{ background: 'var(--surface)', borderRadius: 'var(--r-lg)', border: '1px solid var(--border)', boxShadow: 'var(--sh-sm)', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '0 1.5rem' }}>
            {[
              { id: 'GS', name: 'General Student Council Election 2026', desc: 'All faculties · Opens in 14 days', status: 'Draft', color: 'var(--blue)' },
              { id: 'SE', name: 'Software Engineering Rep Election', desc: 'Dept. of Software Engineering · Closed', status: 'Certified', color: 'var(--green)' },
              { id: 'BA', name: 'Business Faculty Guild Rep', desc: 'Faculty of Business · Results pending sync', status: 'Awaiting certification', color: 'var(--amber)' },
            ].map((el, i) => (
              <div key={el.id} style={{
                ...
                <div style={{
                  ...
                  background: 'var(--surface-3)', color: el.color,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: '0.9375rem', fontWeight: 700, color: 'var(--text-1)' }}>{el.name}</div>
                  <div style={{ fontSize: '0.8125rem', color: 'var(--text-3)' }}>{el.desc}</div>
                </div>
                <div style={{
                  fontSize: '0.75rem', fontWeight: 700, color: el.color,
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.9375rem', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, marginBottom: '2rem', flex: 1 }}>
            General Student Council Election 2026 has not been certified. Results and the public audit ledger will remain unpublished until certification.
          </p>
